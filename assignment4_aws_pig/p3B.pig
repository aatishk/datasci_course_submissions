...
--
good_subjects =  FILTER ntriples BY (subject MATCHES '.*rdfabout\\.com.*') PARALLEL 50;
good_subjects2 = FOREACH good_subjects GENERATE subject as subject2, predicate as predicate2, object as object2;

--
joined = JOIN good_subjects BY object, good_subjects2 BY subject2;
...
-- store joined2 into '/user/hadoop/results-3B' using PigStorage();
STORE joined2 INTO './results-3B' USING PigStorage();
